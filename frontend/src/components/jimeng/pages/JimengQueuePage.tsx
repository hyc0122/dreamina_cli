...
import { jimengApi, type JimengQueueItem, type JimengShot } from "@/lib/jimengApi";
          ...
          {filteredQueue.length > 0 ? (
            <>
              <div className="min-h-0 overflow-auto">
                <table className="min-w-[1180px] table-fixed border-separate border-spacing-0 text-left">
                  ...
                  <tbody>
                    {pageQueue.map((item) => {
                      ...
                      const itemIndex = sortedQueue.findIndex((queueItem) => queueItem.id === item.id);
                      return (
                          ...
                          <td className="border-b border-glass-border px-3 py-2">
                            <div className="flex flex-nowrap items-center gap-1.5">
                              ...
                              <button
                                ...
                                disabled={itemIndex === sortedQueue.length - 1 || isBusy}
                                className="grid h-8 w-8 place-items-center rounded-md border border-glass-border text-text-secondary hover:bg-hover-bg hover:text-foreground disabled:cursor-not-allowed disabled:opacity-40"
                              >
                                <ArrowDown size={14} />
                              </button>
