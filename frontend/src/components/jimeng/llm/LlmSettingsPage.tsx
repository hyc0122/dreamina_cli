...
const JIASU_API_HINT = "https://api.lk888.ai/api";
        ...
        <section className="glass-panel sticky top-0 z-20 rounded-xl bg-app-bg/95 px-5 py-4 backdrop-blur-xl">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              <p className="mt-2 font-mono text-xs text-text-muted">Default API: {JIASU_API_HINT}</p>
          ...
          <div className="flex flex-col gap-2 lg:flex-row lg:items-end lg:justify-between">
            <div>
              ...
              <p className="mt-2 text-sm leading-6 text-text-secondary">
                这些提示词会在资产详情描述之前发送给大模型。人物、场景、道具会自动使用各自前缀。
              </p>
            </div>
